...
module.exports = class extends Language {
  constructor (...args) {
    ...
    this.language = {
      ...
      INHIBITOR_NSFW: 'おっとっとこれはNSFWコマンドのようだ。NSFWチャンネルで使用してね！ https://imgur.com/sbqjt7B',
      ...
      COMMAND_PINGPONG: (diff, ping) => `ネプ! (往復所要時間: ${diff}ms、Heartbeat: ${ping}ms)`,
      COMMAND_INVITE: () => [
      ...
      COMMAND_INFO: [
        ...
        'Repository: https://github.com/dischanet/neptune-discord-bot'
      ],
